...
class StoreShowTimeRequest extends FormRequest
{
    ...
    {
        $movieId = $this->movie_id; // giả sử movie_id được truyền trong request
        $screenId = $this->screen_id; // giả sử screen_id được truyền trong request
        ...
        return [
            'start_timestamp' => [
                ...
                'date',
                'before:end_time',
                function ($attribute, $value, $fail) use ($movieId, $screenId) {
