...
@endif
<form action="{{ route('seat.update', $seat->id) }}" method="post" class="box">
    @csrf
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Nhập thông tin chung của ghế ngồi</p>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row mb20">
                                    ...
                                    <select name="seat_type" class="form-control setupSelect2" id="">
                                        ...
                                        <option {{ $key == old('seat_type') }} {{ $key == $seat->seat_type ? 'selected' : '' }} value="{{ $key }}">
                                            {{ $val }}
                                        </option>
                                        @endforeach
                                    </select>
