...
@endif
<form action="{{ route('review.update', $review->id) }}" method="post" class="box">
    @csrf
                        ...
                        <div class="row mb15">
                            ...
                            <div class="col-lg-12">
                                <div class="form-row mb20">
                                    ...
                                    <select name="movie_id" class="form-control setupSelect2" id="">
                                        ...
                                        <option {{ $key->id == old('movie_id') ? 'selected' : "" }}{{ $key->id == $review->movie_id ? 'selected' : "" }} value="{{ $key->id }}">
                                            {{ $key->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row mb20">
                                    ...
                                    <select name="user_id" class="form-control setupSelect2" id="">
                                        ...
                                        <option {{ $key->id == old('user_id') ? 'selected' : "" }}{{ $key->id == $review->user_id ? 'selected' : "" }} value="{{ $key->id }}">
                                            {{ $key->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row mb20">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9">
                                            <input type="range" name="rating" class="form-range" min="0" max="5" step="0.5" id="customRange3" value="{{ old('rating', $review->rating ?? 2.5) }}">
                                        </div>
                                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-12">
                                <div class="form-row mb20">
                                    <label for="" class="control-label text-left">Nội dung bình luận <span
                                            class="text-danger">(*)</span></label>
                                    <textarea class="form-control" name="comment" id="" rows="5">{{ old('comment', $review->comment ?? "") }}</textarea>
                                </div>
                            </div>
