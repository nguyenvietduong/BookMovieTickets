    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-success pull-right">Tổng số</span>
                    <h5>Bài viết</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">{{ $countArticles }}</h1>
        ...
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">{{ $countCategory }}</h1>
        ...
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">{{ $countTag }}</h1>
