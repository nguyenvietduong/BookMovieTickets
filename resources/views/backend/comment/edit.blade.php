...
@endif
<form action="{{ route('comment.update', $comment->id) }}" method="post" class="box">
    @csrf
                        ...
                        <div class="row mb15">
                            <div class="col-lg-6">
                                <div class="form-row mb20">
                                    ...
                                    <textarea class="form-control" name="content" id="exampleFormControlTextarea1" rows="3">{{ old('content') }}{{ $comment->content ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
