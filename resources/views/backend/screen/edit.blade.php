...
@endif
<form action="{{ route('screen.update', $screen->id) }}" method="post" class="box">
    @csrf
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>Nhập thông tin chung của thể loại phim</p>
                        ...
                        <div class="row mb15">
                            <div class="col-lg-6">
                                <div class="form-row mb20">
                                    <label for="" class="control-label text-left">Tên Thể Loại <span
                            ...
                            <div class="col-lg-6">
                                <div class="form-row mb20">
                                    ...
                                    <select name="screen_type" class="form-control setupSelect2" id="">
                                        ...
                                        <option {{ $key == old('screen_type') }} {{ $key == $screen->screen_type ? 'selected' : '' }} value="{{ $key }}">
                                            {{ $val }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row mb20">
                                    <label for="" class="control-label text-left">Sức Chứa Của Phòng <span
                                            class="text-danger">(*)</span></label>
                                    <input type="number" name="seat_capacity" value="{{ old('seat_capacity', $screen->seat_capacity ?? '' ) }}"
                                        class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
